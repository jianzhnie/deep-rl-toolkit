...
def make_fetch_env(task, training_num, test_num):
    ...
    train_envs = ShmemVectorEnv([
        lambda: TruncatedAsTerminated(gym.make(task))
...
def test_ddpg(args=get_args()):
    ...
    env, train_envs, test_envs = make_fetch_env(args.task, args.training_num,
                                                args.test_num)
    args.state_shape = {
    ...
    net_a = dict_state_dec(Net)(flat_state_shape,
                                hidden_sizes=args.hidden_sizes,
                                device=args.device)
    actor = dict_state_dec(Actor)(net_a,
                                  args.action_shape,
